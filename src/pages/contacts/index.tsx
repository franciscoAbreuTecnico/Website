...
export default function Contacts() {
  ...
  const [submitStatus, setSubmitStatus] = useState<
    "success" | "error" | "invalid-email" | "sending" | null
  >(null); // 'success', 'error', 'invalid-email', 'sending'
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbw70clzSYRz5XVUK7RolqFLJ4X-nxv7VqctHNkQszO4Sp-hWvrWiLEdbvCnveHBdCfp/exec";
        ...
        <div className="relative flex max-md:flex-col items-center justify-center mt-[10vh] max-lg:mt-[18vh]  max-md:p-5">
          ...
          <div className="m-[5%] ml-[10%] w-[60%] p-[1.3%] bg-white rounded-lg shadow-md max-md:w-[90%] max-md:ml-0 max-md:m-0 max-md:mb-8 ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col ">
              <label htmlFor="name" className="mt-3.3 max-md:mt-3 max-md:ml-[5%] max-md:text-sm">
                Name
              </label>
              <input
                type="text"
              ...
              <div className="flex gap-3 mt-3 max-md:flex-col max-md:w-[90%] max-md:ml-[5%]">
                ...
                <div className="flex-1 max-md:mb-3">
                  <label htmlFor="mobile" className="max-md:text-sm">
                    Mobile
                  </label>
                  <input
                    type="tel"
              ...
              <label htmlFor="message" className="mt-3 max-md:text-sm max-md:ml-[5%]">
                Message
              </label>
              <textarea
                id="message"
